...
Esto quiere decir que aproximadamente el 6% de los datos están en zonas de baja variabilidad. Ahora identificamos los pixeles por fuera de las zonas de baja variabilidad usando la función `which()` y almacenamos la ubicación de estos pixeles en el objeto `mascara`:
...
Esto quiere decir que aproximadamente el 5% de los datos están en zonas de baja variabilidad. Ahora identificamos los pixeles por fuera de las zonas de baja variabilidad usando la función `which()` y almacenamos la ubicación de estos pixeles en el objeto `mascara`:
...
Esto quiere decir que aproximadamente el 3% de los datos están en zonas de baja variabilidad. Ahora identificamos los pixeles por fuera de las zonas de baja variabilidad usando la función `which()` y almacenamos la ubicación de estos pixeles en el objeto `mascara`:
...
Esto quiere decir que aproximadamente el 9% de los datos están en zonas de baja variabilidad. Ahora identificamos los pixeles por fuera de las zonas de baja variabilidad usando la función `which()` y almacenamos la ubicación de estos pixeles en el objeto `mascara`:
