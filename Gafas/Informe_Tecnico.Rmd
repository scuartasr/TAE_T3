...
```
En este gráfico notamos el respectivo re-escalamiento y el color de la imagen, como ya estaba en escala de grises no tuvimos que cambiar el formato de color del conjunto de validación.

```{r}
plot(x1,main = "Ejemplo1", axes=T)
plot(x2,main = "Ejemplo2", axes=T)
```
